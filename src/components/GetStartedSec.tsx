      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center md:items-end justify-between gap-12">
        ...
        <div className="relative group max-w-3xl">
          <h2 className="text-[50px] text-center md:text-left md:text-[120px] font-black uppercase md:leading-[130px] leading-[53px]">
            READY TO <br />
            <span className="text-[#e5ff00]">PUSH PAST</span> <br />
            AVERAGE?
          </h2>
          ...
          <div className="mt-4 w-full max-w-[500px]">
            <svg 
              ...
              className="w-full h-auto text-[#e5ff00] opacity-80"
            >
              <path 
        ...
        <div className="shrink-0">
          <button className="bg-[#e5ff00] hover:bg-[#cce600] text-black text-sm md:text-base font-black uppercase px-10 py-5 rounded-sm transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(229,255,0,0.2)]">
            Get Started
          </button>
        </div>
