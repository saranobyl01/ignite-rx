            ...
            {filteredProducts.map(product => (
              <div key={product.id} className="flex flex-col group">
                <div className="relative aspect-square bg-[#999999] mb-4 overflow-hidden">
                  {product.bestseller && (
                    <span className="absolute top-2 left-2 bg-[#e5ff00] text-[10px] font-black uppercase px-2 py-1 z-10">Bestseller</span>
                  )}
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <button className="w-full bg-black text-white font-bold uppercase py-4 text-xs tracking-widest mt-auto hover:bg-[#e5ff00] hover:text-black transition-colors rounded-[4px]">
                    Add to Cart
                  </button>
                </div>
              </div>
